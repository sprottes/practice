...
CREATE TABLE location_city (city_id INTEGER PRIMARY KEY AUTOINCREMENT, city TEXT NOT NULL, country TEXT NOT NULL);
CREATE TABLE locations (location_id INTEGER PRIMARY KEY AUTOINCREMENT, location_address TEXT NOT NULL, location_city_id INTEGER NOT NULL, FOREIGN KEY (location_city_id) REFERENCES location_city (city_id) ON DELETE NO ACTION ON UPDATE CASCADE);
CREATE TABLE supermarkets (supermarket_id INTEGER PRIMARY KEY AUTOINCREMENT, supermarket_name TEXT NOT NULL);
CREATE TABLE supermarket_locations (supermarket_location_id INTEGER PRIMARY KEY AUTOINCREMENT, supermarket_id INTEGER NOT NULL, location_id INTEGER NOT NULL, FOREIGN KEY (supermarket_id) REFERENCES supermarkets (supermarket_id) ON DELETE NO ACTION ON UPDATE CASCADE, FOREIGN KEY (location_id) REFERENCES locations (location_id) ON DELETE NO ACTION ON UPDATE CASCADE);
CREATE UNIQUE INDEX supermarket_locations_supermarket_id_location_id ON supermarket_locations(supermarket_id, location_id);
CREATE TABLE persons (person_id INTEGER PRIMARY KEY AUTOINCREMENT, person_first_name TEXT NOT NULL, person_last_name TEXT NOT NULL, person_birth_date TEXT NOT NULL);
CREATE TABLE contact_types (contact_type_id INTEGER PRIMARY KEY AUTOINCREMENT, contact_type_name TEXT NOT NULL UNIQUE);
CREATE TABLE person_contacts (person_contact_id INTEGER PRIMARY KEY AUTOINCREMENT, person_id INTEGER NOT NULL, contact_type_id INTEGER NOT NULL, contact_value TEXT NOT NULL, FOREIGN KEY (person_id) REFERENCES persons (person_id) ON DELETE NO ACTION ON UPDATE CASCADE, FOREIGN KEY (contact_type_id) REFERENCES contact_types (contact_type_id) ON DELETE NO ACTION ON UPDATE CASCADE);
CREATE TABLE customers (customer_id INTEGER PRIMARY KEY, card_number INTEGER NOT NULL, discount REAL NOT NULL, FOREIGN KEY (customer_id) REFERENCES persons (person_id) ON DELETE NO ACTION ON UPDATE CASCADE);
CREATE TABLE product_categories (category_id INTEGER PRIMARY KEY, category_name TEXT NOT NULL);
CREATE TABLE product_suppliers (supplier_id INTEGER PRIMARY KEY, supplier_name TEXT NOT NULL);
CREATE TABLE product_manufacturers (manufacturer_id INTEGER PRIMARY KEY, manufacturer_name TEXT NOT NULL);
CREATE TABLE product_titles (product_title_id INTEGER PRIMARY KEY, product_title TEXT NOT NULL, product_category_id INTEGER NOT NULL, FOREIGN KEY (product_category_id) REFERENCES product_categories (category_id) ON DELETE CASCADE ON UPDATE NO ACTION);
CREATE TABLE shop_products (product_id INTEGER PRIMARY KEY, product_title_id INTEGER NOT NULL, product_manufacturer_id INTEGER NOT NULL, product_supplier_id INTEGER NOT NULL, unit_price REAL NOT NULL, comment TEXT NOT NULL, FOREIGN KEY (product_title_id) REFERENCES product_titles (product_title_id) ON DELETE CASCADE ON UPDATE NO ACTION, FOREIGN KEY (product_manufacturer_id) REFERENCES product_manufacturers (manufacturer_id) ON DELETE CASCADE ON UPDATE NO ACTION, FOREIGN KEY (product_supplier_id) REFERENCES product_suppliers (supplier_id) ON DELETE CASCADE ON UPDATE NO ACTION);
CREATE TABLE customer_orders (customer_order_id INTEGER PRIMARY KEY AUTOINCREMENT, 	operation_time TEXT NOT NULL, supermarket_location_id INTEGER NOT NULL, customer_id INTEGER DEFAULT NULL, FOREIGN KEY (supermarket_location_id) REFERENCES supermarket_locations(supermarket_location_id) ON DELETE NO ACTION ON UPDATE CASCADE, FOREIGN KEY (customer_id) REFERENCES customers (customer_id) ON DELETE NO ACTION ON UPDATE CASCADE);
CREATE TABLE customer_order_details (customer_order_detail_id INTEGER PRIMARY KEY, 	customer_order_id INTEGER NOT NULL, product_id INTEGER NOT NULL, price REAL NOT NULL, price_with_discount REAL NOT NULL, product_amount INTEGER NOT NULL, FOREIGN KEY (product_id) REFERENCES shop_products (product_id) ON DELETE CASCADE ON UPDATE NO ACTION, FOREIGN KEY (customer_order_id) REFERENCES customer_orders (customer_order_id) ON DELETE CASCADE ON UPDATE NO ACTION);
